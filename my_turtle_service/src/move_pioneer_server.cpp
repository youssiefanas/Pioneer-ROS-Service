...
const float angleTolerance = 0.001;
 ...
 //Pioneer pose callback
void update_turtle_pose(const geometry_msgs::Pose2D::ConstPtr& currentPose) {
...
//rosrun my_turtle_service move_turtle_server /turtle1/cmd_vel:=/pioneer/cmd_vel
...
bool get_pose(my_turtle_service::goal::Request &req, my_turtle_service::goal::Response &res){
    ...
    ros::Subscriber turtle_pose_sub = node.subscribe("/pioneer/pose", 0, update_turtle_pose);
